...
Original file is located at
    https://colab.research.google.com/drive/1zAGJ8ah6PjI_p4ggya3tlEBvZFxPI33e
"""
...
# CSV 파일 읽기
file_path = 'C:/Users/user/eclipse-workspace/path/src/path/최단경로_최종.py'
...
threshold_distance = 5.0  # km로 설정하여 더 많은 노드 연결
